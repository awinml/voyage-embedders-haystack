# voyage-4-lite Model Specification

## Quick Reference

| Property | Value |
|----------|-------|
| Model ID | `voyage-4-lite` |
| Model Type | Embedding |
| Default Dimensions | 1024 |
| Flexible Dimensions | 256, 512, 1024, 2048 |
| Max Input Tokens | 32,000 |
| Max Batch Tokens | 1,000,000 |
| Output Data Types | float, int8, uint8, binary, ubinary |

## Description

Optimized for latency and cost. Best performance-to-cost ratio in the voyage-4 series with the highest batch throughput.
...
- **Best performance-to-cost ratio** in voyage-4 series
- **Highest batch throughput** (1M tokens per batch)
